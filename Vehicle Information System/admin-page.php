                    ...
                    <div class="mydropdown">
                        <div class="dropdown show">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="addnew-page.php">Add New Data</a>
                                <a class="dropdown-item" href="edit-update-page.php">Edit And Update Data</a>
                                <a class="dropdown-item" href="delete.php">Delete Data</a>
                                <hr>
                                <a class="dropdown-item" href="view-user.php">View Users</a>
                                <a class="dropdown-item" href="delete-user.php">Delete Users</a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="search-control">
        <div class="container h-100">
            <div class="row h-100 justify-content-center align-items-center">
                <form class="form-inline" action="admin-page.php" method="POST">
                    <div class="form-group mb-2">
                        <div class="form-group mx-sm-3 mb-2">
                            <input type="text" class="form-control form-control-sm" id="search-field" name="filter" placeholder="Search By Name Or Id">
                        </div>
                    </div>
                    <button type="submit" name="submit" class="btn btn-sm btn-danger mb-2" id="submit-button">Search</button>
                </form>
            </div>
        </div>
    </div>
