...
<head>
    ...
    <!--Local CSS-->
    <link rel="stylesheet" type="text/css" href="css/delete-style.css" />
    <!--Local CSS-->
...
<body>
    ...
    <div class="first-container">
      <div class="main-form">
        <div class="header">
          <h5>Delete Car Information Permanently</h5>
        </div>
        <div class="form-container">
            <form class="deleteform" action="include/delete-connection.php" method="POST">
            ...
            <h6>Warning : Car Details Will Be Permanently Deleted</h6>
          </form>
        </div>
      </div>
    </div>
