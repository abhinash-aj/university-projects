...
<head>
    ...
    <!--Local CSS-->
    <link rel="stylesheet" type="text/css" href="css/userlogin-style.css" />
    <!--Local CSS-->
    
    <!--Local JS-->
    <script src="javascript/userloginscript.js"></script>
    <!--Local JS-->
        ...
        <div class="main-container">
            <div class="container h-100">
                <div class="row h-100 justify-content-center align-items-center">
                    <form class="login-form" id="log-form" action="include/user-login-connection.php" method="POST">
                    <div class="container">
                        ...
                        <hr>
                        <button type="submit" name="submit" id='loginbutton' class="btn btn-outline-primary btn-sm">Login</button>
