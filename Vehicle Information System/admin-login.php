...
<head>
    ...
    <!--Local CSS-->
    <link rel="stylesheet" type="text/css" href="css/adminlogin-style.css" />
    <!--Local CSS-->
    
    <!--Local JS-->
    <script src="javascript/adminloginscript.js"></script>
    <!--Local JS-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
        ...
        <div class="main-container">
            <div class="container h-100">
                <div class="row h-100 justify-content-center align-items-center">
                    <form class="login-form" id="log-form" action="include/admin-login-connection.php" method="POST">
                    <div class="container">
                        ...
                        <hr>
                        <button type="submit" name="submit" id='loginbutton' class="btn btn-outline-danger btn-sm">Login</button>
        ...
        if(isset($_GET['error'])) {
            if($_GET['error'] == "empty") {
                echo '<script type="text/javascript">alert_empty();</script>';
            }
            elseif($_GET['error'] == "doesntexist") {
                echo '<script type="text/javascript">alert_noexist();</script>';
            }
            elseif($_GET['error'] == "wrongpassword") {
                echo '<script type="text/javascript">alert_wrongpass();</script>';
            }
        }
