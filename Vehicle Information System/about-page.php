...
<head>
    ...
    <!--Local CSS-->
    <link rel="stylesheet" type="text/css" href="css/aboutpage-style.css" />
    <!--Local CSS-->
...
<body>
    ...
    <div class="d-flex flex-wrap justify-content-center align-items-center" id="card-id">
            <div class="aboutme-container">
                    ...
                    <hr>
                    <p>
                        <b>Name</b> <br> Arpan Abhinash Jena <br> <br>
                        <b>Course</b> <br> BCA 6th Sem<br> <br>
                        <b>College</b> <br> Garden City College
                    </p>
                </div>
                <div class="aboutproject-container">
                    <h4>About Project</h4>
                    <hr>
                    <p>
                        <b>Title</b> <br> CAR INFORMATION SYSTEM <br><br>
                        <b>Programming Languages Used</b> <br> HTML <br> CSS <br> PHP <br> JAVACSRIPT <br><br>
                        <b>Framework Used</b> <br> BOOTSTRAP 4.0 <br><br>
                        <b>Editor Used</b> <br> VISUAL STUDIO CODE <br> SUBLIME TEXT 3<br>
                    </p>
                </div>
    </div>
    <!--About-->
